...
from .views import CallSignDetailView, CallSignCreate, CallSignUpdate, CallSignClaimView, CountryViewSet, DXCCEntryViewSet, CallSignViewSet, UserCallSignViewSet, CallSignCreateAPIView, CallSignSearchView
...
urlpatterns = [
    ...
    path('c/<slug>/claim', CallSignClaimView.as_view(), name='callsign-html-claim'),
    path('c/search', CallSignSearchView.as_view(), name='callsign-html-search'),

    path('api/callsign', CallSignCreateAPIView.as_view()),
