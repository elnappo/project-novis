    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dxcc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='callsign.DXCCEntry', verbose_name='DXCC')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='callsign.Country')),
                ('telco_agency', models.ForeignKey(blank=True, help_text='Related telecommunication agency', null=True, on_delete=django.db.models.deletion.PROTECT, to='callsign.TelecommunicationAgency')),
            ],
            options={
