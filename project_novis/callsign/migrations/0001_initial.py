# Generated by Django 2.1.4 on 2019-01-19 21:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clublog_oqrs', models.NullBooleanField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adif_name', models.CharField(blank=True, db_index=True, max_length=64, null=True)),
                ('geonames_id', models.PositiveIntegerField(blank=True, null=True)),
                ('osm_relation_id', models.PositiveIntegerField(blank=True, null=True)),
                ('itu_object_identifier', models.CharField(blank=True, max_length=16, null=True)),
                ('itu_letter_code', models.CharField(blank=True, max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callsign_data_url', models.URLField(blank=True, max_length=256, null=True)),
                ('callsign_data_description', models.TextField(blank=True, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='callsign.Country')),
            ],
            options={
                'abstract': False,
            },
